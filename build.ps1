...
{
    # project config
    $buildProject = 'PerformanceTypes.sln'
    $nugetProject = 'PerformanceTypes\PerformanceTypes.csproj'
    $testProject = 'PerformanceTypes.Tests\PerformanceTypes.Tests.csproj'
